...
call s:h("SpecialKey"      , [s:p.dim_white , "NONE"        , s:fmt_none])
...
call s:h("StatusLine"      , [s:p.white     , s:p.black     , s:fmt_none])
call s:h("StatusLineNC"    , [s:p.gray      , s:p.black     , s:fmt_none])
